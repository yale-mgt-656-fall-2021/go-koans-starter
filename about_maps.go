...
// A map is a data type that allows use to access information using
// key/value pairs. We store a value with a key identifier, so we can
// easily look up the value when we need it. 
// Resources:
